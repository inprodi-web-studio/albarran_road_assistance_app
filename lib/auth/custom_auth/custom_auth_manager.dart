...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    albarranRoadAssistantAuthUserSubject.add(
      AlbarranRoadAssistantAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<AlbarranRoadAssistantAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  AlbarranRoadAssistantAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = AlbarranRoadAssistantAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    albarranRoadAssistantAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
AlbarranRoadAssistantAuthUser? currentUser;
